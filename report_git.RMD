...
## The Ask
DCPO Halawa and Data Analyst Loftus asked if it would be possible to use the [Cook County Medical Examiner Office](https://maps.cookcountyil.gov/medexammaps/)(ME) data to supplement the department's internal tracking of department involved youth killed in gun-related deaths. Due to confidentiality concerns regarding department data, this report demonstrates how the the ME's data can be transformed to support this research. It does not allow for the identification of specific youth. This report is a prototype that can help illustrate the possibilities of GIS powered reports and dashboards within the department's constraints regarding confidentiality.

### Importing the Data 
Importing the medical examiner's (ME) office data is simple task: The [Cook County Open Data website](https://datacatalog.cookcountyil.gov) has a link that, when incorporated into the `R` code of the report, allows for direct connection to the Open Data Portal. This eliminates the need of downloading files, ensures the most up to date data, and simplifies the data cleaning process.
